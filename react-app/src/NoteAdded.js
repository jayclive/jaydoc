...
const NoteAdded = ({
  ...
  const [addedToFavouriteNotification, setAddedToFavouriteNotification] =
    useState(false);
  const ItemAndTitle = () => {
    return (
      <>
            ...
            return {
              ...
              details: [
                ...itItem.details,
                {
                  ...
                  detailsContent: <p id="NoteSubtitle">{item.subTitle}</p>,
                },
              ],
              subTitle: "",
            };
      ...
      {!AppValue.themeTrue && (
        <div id="entireNewNoteDarkMode">
          <div className="titleAndIconContainer">
            ...
            {addedToFavouriteNotification && (
              <p id="addedToFavouritesNotification">Added to favourites</p>
            )}
            <div id="togglerAndDelete">
              {item.isDone && !item.addedToFavourite && (
                <button
                  ...
                  onClick={() => {
                    ...
                    AppValue.setMiniNoteLayoutNotificationIcon(true);
                    setFavourite((items) => {
                      return items.map((itItem) => {
                        if (itItem.id === item.id) {
                          return {
                    ...
                    AppValue.setFavourite((prev) => [...prev, item]);

                    AppValue.setFavourite((items) => {
                      return items.map((itItem) => {
                        if (itItem.id === item.id) {
                          return {
                            ...itItem,
                    ...
                    setAddedToFavouriteNotification(() => {
                      setAddedToFavouriteNotification(true);
                      setTimeout(() => {
                        setAddedToFavouriteNotification(false);
                      }, 1000);
                    });
                  }}
                ></button>
              ...
              <h3
                type="button"
                className="fas fa-trash deleteNoteDarkMode"
                onClick={handleClick}
                title="Delete note"
                id="deleteButton"
              ></h3>
      ...
      {AppValue.themeTrue && (
        <div id="entireNewNoteLightMode">
          <div className="titleAndIconContainer">
            ...
            {emptyNoteWarning && (
              <p id="emptyNoteWarning">Note can't be empty</p>
            )}
            {addedToFavouriteNotification && (
              <p id="addedToFavouritesNotification">Added to favourites</p>
            )}
            ...
            <div id="togglerAndDelete">
              ...
              <h3
                type="button"
                className="fas fa-trash deleteNoteLightMode"
                onClick={handleClick}
                title="Delete note"
                id="deleteButton"
              ></h3>
